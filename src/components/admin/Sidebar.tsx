...
const nav = [
  ...
  { href: "/admin/retiros", label: "Retiros", icon: "self_improvement" },
  { href: "/admin/pqrsf", label: "PQRSF", icon: "forum" },
  { href: "/admin/reviews", label: "Reseñas", icon: "reviews" },
  { href: "/admin/reportes", label: "Reportes", icon: "insights" },
